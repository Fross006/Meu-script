-- V35.3.4 — pupila do ESP ancorada no centro e arcos do Wi-Fi com margem contra recortes.
    ...
    if kind == "PING" then
        ...
        for index = 0, 3 do
            ...
            if index == 0 then
                ...
                -- Keep clear space above the stroke after rounding to physical screen pixels.
                -- The lower edge still clips at the arc tips; the top never trims the curve.
                local padding = 5
                local clip = Util.New("Frame", {Name = "CircularArcClip",
                    Position = UDim2.fromOffset(16 - radius - padding, 27 - radius - padding),
                    Size = UDim2.fromOffset(radius * 2 + padding * 2, radius - extent + padding),
                    BackgroundTransparency = 1, BorderSizePixel = 0, ClipsDescendants = true}, native)
                local ring = Util.New("Frame", {Name = "SignalArc", Position = UDim2.fromOffset(padding, padding),
